...
export const mockRoles: readonly { readonly name: string; readonly grants: readonly string[] }[] = [
  { name: "Administrator", grants: ["chat-destination:manage", "chat-destination:read", "github-connection:manage", "github-connection:read", "notifications:read", "watched-repositories:manage", "watched-repositories:read"] },
];
